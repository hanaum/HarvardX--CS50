/* Resize: Resizes 24-bit uncompressed BMPs by a factor of n.

Usage: ./resize n infile outfile
ex: ./resize 4 small.bmp large.bmp
...
int main(int argc, char* argv[])
{
    ...
    newBi.biSizeImage = abs(newBi.biHeight) * (sizeof(RGBTRIPLE) * newBi.biWidth + outPadding);
    ...
    bf.bfSize = (newBi.biSizeImage + sizeof(BITMAPINFOHEADER) + sizeof(BITMAPFILEHEADER));
